...
carPriceObj = CarPrice()
# print(carPriceObj.df.head())

carPriceObj.trim()

df_train, df_val, df_test, y_train_orig, y_val_orig, y_test_orig, y_train, y_val, y_test = carPriceObj.validate()

X_train = carPriceObj.prepare_X(df_train)

w_0, w = carPriceObj.linear_regression(X_train, y_train)

y_pred = w_0 + X_train.dot(w)

# testing the model

X_val = carPriceObj.prepare_X(df_val)
...
print(df_val[['make', 'model', 'engine_cylinders', 'transmission_type', 'driven_wheels', 'number_of_doors',
